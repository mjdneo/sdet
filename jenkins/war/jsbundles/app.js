  ...
  return {
    ...
    render: () => {
      return `<a class="jenkins-command-palette__results__item" href="${xmlEscape(params.url)}">
        <div class="jenkins-command-palette__results__item__icon">${params.icon}</div>
...
function command_palette_init() {
  ...
  makeKeyboardNavigable(searchResultsContainer, () => searchResults.querySelectorAll("a"), hoverClass);
